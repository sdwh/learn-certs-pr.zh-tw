...
**第 6 步：** 驗證帳號時，您必須使用用於活動報名的相同社交帳號進行驗證(附註：如果您使用 Microsoft 帳號進行活動報名，則必須使用相同的 Microsoft 帳號登錄到認證個人資料以安排測驗。如果這導致有兩個認證個人資料，[聯絡 Microsoft 認證支援論壇](https://trainingsupport.microsoft.com/mcp/forum?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=All&isFilterExpanded=false&page=1) 以便完成您認證測驗後，合併您的個人資料)。  
...
**答案：** 透過 [Microsoft 認證支援論壇] 獲得幫助 (https://trainingsupport.microsoft.com/mcp/forum?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=All&isFilterExpanded=false&page=1) ([https://aka.ms/CertificationSupport](https://aka.ms/CertificationSupport))。版主將在一個工作日內回覆。
