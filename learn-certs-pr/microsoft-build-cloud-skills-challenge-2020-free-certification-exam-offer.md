...
關於安排測驗的問題，請透過 [Microsoft認證支援論壇](https://trainingsupport.microsoft.com/en-us/mcp/forum) 獲得協助。論壇版主將在一個工作日內回覆。
...
**答案：** 此優惠涵蓋了所有 Microsoft 基本知識、role-based 和專業化認證測驗。有關合格認證測驗的列表，請參見我們的“優惠詳細資訊”頁面上的“[Eligible exams](#eligible-exams) ”部分。

**問: 如果我註冊了Microsoft Build，但沒有註冊或完成“ Cloud Skills Challenge”，我是否仍可以申請此優惠？**

**答案：** 不可以，此優惠僅適用於已參加Microsoft Build並完成了Cloud Skills Challenge中的其中一個系列的人員。
...
**答案：** 您可以透過聯絡 [Microsoft Certification Support](https://trainingsupport.microsoft.com/en-us/mcp/forum)獲得幫助。版主將在一個工作日內回覆。
