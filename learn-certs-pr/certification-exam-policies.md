...
1. 通用 Microsoft Certification 測驗重考政策
    ...
    **由於考生缺乏準備、知識、技能或能力，或者如果請求中未包含Pearson VUE案件編號，則測驗重考例外將不會被授予失敗。**
...
倘若您在正式測驗發佈日期後兩週內仍未與線上看到成績單或收到成績單，請聯絡測驗辦理單位，以進一步了解完成處理您測驗結果的時間。如果您對成績單有疑問，請聯絡 [認證支援](https://aka.ms/mcpforum)。
